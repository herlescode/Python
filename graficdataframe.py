...
dados_games = """Rank,Name,Platform,Year,Genre,Publisher,NA_Sales,EU_Sales,JP_Sales,Other_Sales,Global_Sales
...
"""
df = pd.read_csv(io.StringIO(dados_games))
...
#vendas_por_genero.plot(kind='bar',figsize=(10, 6))
plt.title('Vendas Globais por genero')
plt.xlabel('GÊnero')
plt.ylabel('Vendas Globais(em milhoes)')
